...
export default function PocketGuardAlternative() {
  ...
  const slug = '/pocketguard-alternative';
  ...
  return (
    <>
      <SEOHead
        ...
        keywords="pocketguard alternative, cheaper than pocketguard, pocketguard replacement, best alternative to pocketguard, free budgeting app, google sheets budgeting, pocketguard plus alternative"
      />
      ...
      <StructuredData
        ...
        items={[
          ...
          { name: 'The PocketGuard Alternative That Lets You Own Your Data', url: `https://sheetlink.app${slug}` }
        ]}
      />
